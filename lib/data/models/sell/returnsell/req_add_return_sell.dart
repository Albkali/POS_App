...
ReqAddReturnSell reqAddReturnSellFromJson(String str) =>
    ReqAddReturnSell.fromJson(json.decode(str));

String reqAddReturnSellToJson(ReqAddReturnSell data) =>
...
class ReqAddReturnSell {
  ...
  factory ReqAddReturnSell.fromJson(Map<String, dynamic> json) =>
      ReqAddReturnSell(
