...
ResBeforeClose resBeforeCloseFromJson(String str) =>
    ResBeforeClose.fromJson(json.decode(str));
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        firstTable: List<List<String>>.from(
            json["first_table"].map((x) => List<String>.from(x.map((x) => x)))),
        secondTable: List<List<dynamic>>.from(json["second_table"]
            .map((x) => List<dynamic>.from(x.map((x) => x)))),
        thirdTable: List<ThirdTable>.from(
            json["third_table"].map((x) => ThirdTable.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "first_table": List<dynamic>.from(
            firstTable.map((x) => List<dynamic>.from(x.map((x) => x)))),
        "second_table": List<dynamic>.from(
            secondTable.map((x) => List<dynamic>.from(x.map((x) => x)))),
...
class ThirdTable {
  ...
  factory ThirdTable.fromJson(Map<String, dynamic> json) => ThirdTable(
        ...
        subTotal: json["sub_total"] == null
            ? null
            : List<List<String>>.from(json["sub_total"]
  ...
  Map<String, dynamic> toJson() => {
        ...
        "sub_total": subTotal == null
            ? null
            : List<dynamic>.from(
                subTotal!.map((x) => List<dynamic>.from(x.map((x) => x)))),
      };
}
